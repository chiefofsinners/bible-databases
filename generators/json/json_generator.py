        ...
        for book in prepared_data['books']:
            ...
            for chapter in book['chapters']:
                ...
                for verse in chapter['verses']:
                    ...
                    # Include inline footnotes if present
                    if 'footnotes' in verse:
                        verse_data["footnotes"] = verse['footnotes']
                    chapter_data["verses"].append(verse_data)
                book_data["chapters"].append(chapter_data)
            structured_data["books"].append(book_data)

        # Include top-level footnotes array if present
        if self.has_footnotes(prepared_data):
            structured_data["footnotes"] = prepared_data['footnotes']
