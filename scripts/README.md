...
- **extract_sword_footnotes.py**
  - **Description**: Extracts footnotes (marginal notes) from a SWORD module and adds them to the source JSON. Currently processes the KJV, which contains 6,959 footnotes with Hebrew/Greek literal translations and alternative English readings.
  - **Usage**: Run the script to extract KJV footnotes. Source JSON is updated in-place.
