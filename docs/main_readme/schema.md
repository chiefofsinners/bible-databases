...
#### Table: `<translation>_footnotes`
This table contains footnotes (marginal notes) for translations that include them, such as the KJV. If a translation does not have footnotes, this table will not be generated.

| Column Name   | Type          | Nullable | Key         | Default | Extra          | Description                                              |
|---------------|---------------|----------|-------------|---------|----------------|----------------------------------------------------------|
| `id`          | int           | NO       | Primary Key | NULL    | auto_increment | Unique identifier for each footnote.                     |
| `book`        | varchar(255)  | YES      | Index       | NULL    |                | The name of the book.                                    |
| `chapter`     | int           | YES      |             | NULL    |                | The chapter number.                                      |
| `verse`       | int           | YES      |             | NULL    |                | The verse number.                                        |
| `catch_word`  | varchar(255)  | YES      |             | NULL    |                | The word or phrase in the verse the note references.      |
| `note_text`   | text          | YES      |             | NULL    |                | The text of the footnote.                                |
| `note_type`   | varchar(50)   | YES      |             | NULL    |                | Type of note: `literal` (Hebrew/Greek), `alternate` (English alternative), or `mixed`. |
